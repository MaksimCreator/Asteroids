...
namespace CompositeRoot
{
    public class ShipCompositeRoot : CompositeRoot
    {
        ...
        public void DisableShip() => _shipInputRouter.OnDisable();

        private void OnShot(Bullet bullet) => _bulletsSimulation.Simulate(bullet, _shipModel.Position, _shipMovement.Forward);
